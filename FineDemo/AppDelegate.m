...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    self.window.rootViewController = [[FDNavigationViewController alloc]initWithRootViewController:[[ViewController alloc]init]];
    
    

    [PluginHelperOC startLog];
    [self configPlugin];
    [PluginHelperOC InitPluginWithAppKey:AppKey withPubId:pubId bannerLocation:VIEW_LOACTION isPortrait:YES isDebug:YES completionHandler:^(BOOL success) {
//        [PluginHelperOC showBanner];
        [PluginHelperOC debugHelperSetUp];
    }];
    [PluginHelperOC showInterstitialWithPage:@"home" withEntry:@"" shownHandler:^(){} completionHandler:^(BOOL isClosed) {}];
    [PluginHelperOC setPostionOfLandscapeInPortraitMode:VIEW_LOACTION];
...
- (void)configPlugin
{
    NSArray *admobTestIds = [NSArray arrayWithObjects:
                             ...
                             @"ddea44284f8d27907ac78e4f8ae3e3a2"//liuyaqiang
                             , nil];
    NSArray *facebookTestIds = [NSArray arrayWithObjects:
                                ...
                                @"b602d594afd2b0b327e07a06f36ca6a7e42546d0",// zhangqiang
                                @"d6cf1d3cb52ca70be18891ca2038dd80d0fea8bb"//ipad 5th
                                , nil];
    ...
    [PluginHelperOC setFacebookTrack:@"123456789123456"];
...
- (void)applicationWillEnterForeground:(UIApplication *)application {
    ...
    [PluginHelperOC showInterstitialWithPage:@"switchin" withEntry:@"" shownHandler:^(){} completionHandler:^(BOOL isClosed) {}];
